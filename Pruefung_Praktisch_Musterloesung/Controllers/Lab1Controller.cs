...
namespace Pruefung_Praktisch_Musterloesung.Controllers
{
    public class Lab1Controller : Controller
    {
         ...
         * #2: https://www.myapp.ch/admin/dashboard
         * https://www.myapp.ch/User1/dashboard
         * #3:Hacker bekommt Zugriff auf verschiedene Seiten, die nicht geschützt sind. Er probiert verschiedene URL's aus (zB. ~/Admin).
         * Falls er Zugriff bekommt, kann er auf der Admin Seite zB. User editieren, Passwörter ändern etc.
         * */
